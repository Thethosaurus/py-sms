...
account_sid = "AC61c6bb651cd410fc07d84acbab20641c"
auth_token = "03e1e37b8de4d341fef3181cdaaf3860"  
fromnumber = "+13125487821"
...
name = ""
while user != "q":
	response, state, platypoints, name = response_handler(user, state, platypoints, name)
